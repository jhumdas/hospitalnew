<section class="HospitalAbt">
    <div class="custContainer">
        <div class="HospitalAbtTop">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12 mb-3">
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link tabBtnLink active show" id="v-pills-Heart-tab" data-toggle="pill" href="#v-pills-Heart" role="tab" aria-controls="v-pills-Heart" aria-selected="true"><img src="./assets/images/heart.png" alt="heart">
                            <span>Heart</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Spine-tab" data-toggle="pill" href="#v-pills-Spine" role="tab" aria-controls="v-pills-Spine" aria-selected="false"><img src="./assets/images/spine.png" alt="spine">
                            <span>Spine</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Orthopedics-tab" data-toggle="pill" href="#v-pills-Orthopedics" role="tab" aria-controls="v-pills-Orthopedics" aria-selected="false"><img src="./assets/images/Orthopaedics.png" alt="Orthopaedics">
                            <span>Orthopedics</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-CancerCare-tab" data-toggle="pill" href="#v-pills-CancerCare" role="tab" aria-controls="v-pills-CancerCare" aria-selected="false"><img src="./assets/images/Cancer.png" alt="Cancer">
                            <span>Cancer Care</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Neurosciences-tab" data-toggle="pill" href="#v-pills-Neurosciences" role="tab" aria-controls="v-pills-Neurosciences" aria-selected="false"><img src="./assets/images/Neurosciences.png" alt="Neurosciences">
                            <span>Neurosciences</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Gastroenterology-tab" data-toggle="pill" href="#v-pills-Gastroenterology" role="tab" aria-controls="v-pills-Gastroenterology" aria-selected="false"><img src="./assets/images/Gastroentrology.png" alt="Gastroentrology">
                            <span>Gastroenterology</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Transplants-tab" data-toggle="pill" href="#v-pills-Transplants" role="tab" aria-controls="v-pills-Transplants" aria-selected="false"><img src="./assets/images/Transplant.png" alt="Transplant">
                            <span>Transplants</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-CriticalCare-tab" data-toggle="pill" href="#v-pills-CriticalCare" role="tab" aria-controls="v-pills-CriticalCare" aria-selected="false"><img src="./assets/images/critical care.png" alt="critical care">
                            <span>Critical Care</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Bariatricsurgery-tab" data-toggle="pill" href="#v-pills-Bariatricsurgery" role="tab" aria-controls="v-pills-Bariatricsurgery" aria-selected="false"><img src="./assets/images/Bariatric surgery.png" alt="Bariatric surgery">
                            <span>Bariatric Surgery</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Robotics-tab" data-toggle="pill" href="#v-pills-Robotics" role="tab" aria-controls="v-pills-Robotics" aria-selected="false"><img src="./assets/images/Robotics.png" alt="Robotics">
                            <span>Robotics</span></button>

                        <button class="nav-link tabBtnLink" id="v-pills-Medicine-tab" data-toggle="pill" href="#v-pills-Medicine" role="tab" aria-controls="v-pills-Medicine" aria-selected="false"><img src="./assets/images/Preventive Medicine.png" alt="Medicine">
                            <span>Preventive Medicine</span></button>
                ...
                <div class="col-lg-9 col-md-8 col-sm-12">
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-Neurosciences" role="tabpanel" aria-labelledby="v-pills-Neurosciences-tab">
                            <h5 class="tabBigHead">Lorem Ipsum Neurosciences Expertise</h5>
                            <p class="tabContentPara">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem, possimus! Perspiciatis, in amet officiis sint, minus qui ad delectus at repudiandae aliquam molestias natus facere.</p>
                            <p class="tabContentPara">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum reiciendis error eius accusamus earum distinctio deserunt esse itaque magnam reprehenderit nobis eveniet, beatae ipsa cupiditate sunt sint ut deleniti facere temporibus perferendis suscipit iure praesentium repudiandae? Laboriosam id minima ipsam necessitatibus, earum doloremque aperiam iste. Recusandae tenetur quae voluptatum aperiam.</p>
                            <p class="tabContentPara">Neurosurgery a branch of surgery involved with the brain injury, spine and nerves, is a key specialty at Apollo hospitals. Our neurosurgery doctors treat neurological diseases such as brain injury or diseases, head injury, spinal injury, brain tumors, spinal tumors, brain hemorrhage, hydrocephalus, nerve injuries, tumors, disc prolapse or herniation, spinal dislocation, unstable spine, congenital malformations like atlanto-axial dislocation, spinal dysraphism etc. Treatment of seizures or epilepsy as well as modern treatments for movement disorders like Parkinson’s disease are further specializations. More than 1000 major neurosurgeries are being carried out every year.</p>
                            <p class="tabContentPara">Today, Neuroanaesthesia, Neurosurgical intensive care and Neuro-imaging technology have advanced so much that mortality has significantly reduced and functional outcomes have improved tremendously. Minimally invasive techniques help decrease the mortality and morbidity associated with surgery.</p>
                            <p class="tabContentPara">With a team led by some of the best neurosurgeons in India, preservation of all functions, good cosmetic outcome, shorter hospital stay and avoiding pain and discomfort are considered as important as saving a patient’s life. The integrated team of neurologists, neurosurgeons, neuroanesthetists, neuro physicians and intensivists along with rehabilitation specialists are dedicated to this goal.</p>
                        </div>

                        <div class="tab-pane fade" id="v-pills-Gastroenterology" role="tabpanel" aria-labelledby="v-pills-Gastroenterology-tab">
                            <h5 class="tabBigHead">Lorem Ipsum Gastroenterology</h5>
                            <p class="tabContentPara">The Institutes of Gastroenterology are regarded as one of the best & top gastroenterology hospital in India. We are dedicated to the management of diseases of the digestive and hepatobiliary systems in children and adults. The gastroenterology surgeons offers expert care in both Medical and Surgical Gastroenterology. The Institutes possess modern state of art equipment backed by advanced intensive care units.</p>
                        ...
                        <div class="tab-pane fade" id="v-pills-Transplants" role="tabpanel" aria-labelledby="v-pills-Transplants-tab">
                            <h5 class="tabBigHead">Lorem Ipsum Transplant</h5>
                            <p class="tabContentPara">The Apollo Institutes of Transplant program is one of the world’s largest and most comprehensive solid multi-organ transplantation in India</p>
                            <p class="tabContentPara">The Institutes are well known for several multi-organ transplant procedures such as liver transplant, kidney transplant, corneal transplant, heart transplant, intestinal and GI transplant, pancreatic transplant and pediatric transplant. Apollo Hospitals has been a leader in the field of organ transplants and has been considered as one of the best organ transplant hospitals in India. The first successful pediatric and adult liver transplants in India were performed at Apollo Hospitals in November 1998. With over 90% success rates for multiple transplants in India our organ transplant center is a beacon of quality and hope for patients from across the world.</p>
                            <p class="tabContentPara">The experience and expertise of our Consultants, integrated team approach, superior outcomes and the excellent infrastructure make Apollo Hospitals an ideal choice for transplants. Our Organ Transplant Surgeon and allied teams work with the organ donor and recipient before, during and after surgery to ensure the greatest likelihood of superior results.</p>
                            <p class="tabContentPara">Our Transplant Centres have all the necessary high-end equipment and state of the art infrastructure to perform living donor surgery and cadaver surgery. An eminent pool of internationally renowned Transplant Surgeons, Nephrologists, Gastroenterologists, Pediatric Gastroenterologists, Pediatric Surgeons, Anesthetists, Intensivists and Physicians deliver the highest standards of care. Over the past decade the Institutes have built up a reputation of excellence and expertise.</p>
                            <div class="tabContentBtnDiv">
                                <a href="#" class="tabContentBtn">READ MORE</a>
                            </div>
                        </div>

                        <div class="tab-pane fade" id="v-pills-CriticalCare" role="tabpanel" aria-labelledby="v-pills-CriticalCare-tab">
                            <h5 class="tabBigHead">Lorem Ipsum Critical Care</h5>
                            <p class="tabContentPara">The Apollo Institutes of Transplant program is one of the world’s largest and most comprehensive solid multi-organ transplantation in India</p>
                            <p class="tabContentPara">The Institutes are well known for several multi-organ transplant procedures such as liver transplant, kidney transplant, corneal transplant, heart transplant, intestinal and GI transplant, pancreatic transplant and pediatric transplant. Apollo Hospitals has been a leader in the field of organ transplants and has been considered as one of the best organ transplant hospitals in India. The first successful pediatric and adult liver transplants in India were performed at Apollo Hospitals in November 1998. With over 90% success rates for multiple transplants in India our organ transplant center is a beacon of quality and hope for patients from across the world.</p>
                            <p class="tabContentPara">The experience and expertise of our Consultants, integrated team approach, superior outcomes and the excellent infrastructure make Apollo Hospitals an ideal choice for transplants. Our Organ Transplant Surgeon and allied teams work with the organ donor and recipient before, during and after surgery to ensure the greatest likelihood of superior results.</p>
                            <p class="tabContentPara">Our Transplant Centres have all the necessary high-end equipment and state of the art infrastructure to perform living donor surgery and cadaver surgery. An eminent pool of internationally renowned Transplant Surgeons, Nephrologists, Gastroenterologists, Pediatric Gastroenterologists, Pediatric Surgeons, Anesthetists, Intensivists and Physicians deliver the highest standards of care. Over the past decade the Institutes have built up a reputation of excellence and expertise.</p>
                        ...
                        <div class="tab-pane fade" id="v-pills-Bariatricsurgery" role="tabpanel" aria-labelledby="v-pills-Bariatricsurgery-tab">
                            <h5 class="tabBigHead">Lorem Ipsum Bariatric Surgery Expertise</h5>
                            <p class="tabContentPara">The Apollo department of Spine is regarded as one of the top & best hospitals for spine surgery in India with a legacy of innovation and excellence.</p>
                            <p class="tabContentPara">The spine surgeons perform major and complex spine surgery. Apollo Hospitals is indeed a pioneer and one of the foremost institutions for spine surgery. The spine surgery units at the various Apollo Hospitals locations are a conglomeration of spine specialists in the treatment of spinal disorders, cancers, deformities as well as specialists in the areas of pain management and physiotherapy. Some of the latest techniques including minimally invasive and robotic surgeries have been done at the various hospitals of the group. The complete range of management options for treating back pain and spinal disorders are available. Our Spine doctors will check for list of common spine diseases and conditions of the patient and provide treatment based on the observation.</p>
                        ...
                        <div class="tab-pane fade" id="v-pills-Robotics" role="tabpanel" aria-labelledby="v-pills-Robotics-tab">
                            <h5 class="tabBigHead">Lorem Ipsum Robotic Surgery</h5>
                            <p class="tabContentPara">The Apollo department of Spine is regarded as one of the top & best hospitals for spine surgery in India with a legacy of innovation and excellence.</p>
                            <p class="tabContentPara">The spine surgeons perform major and complex spine surgery. Apollo Hospitals is indeed a pioneer and one of the foremost institutions for spine surgery. The spine surgery units at the various Apollo Hospitals locations are a conglomeration of spine specialists in the treatment of spinal disorders, cancers, deformities as well as specialists in the areas of pain management and physiotherapy. Some of the latest techniques including minimally invasive and robotic surgeries have been done at the various hospitals of the group. The complete range of management options for treating back pain and spinal disorders are available. Our Spine doctors will check for list of common spine diseases and conditions of the patient and provide treatment based on the observation.</p>
                        ...
                        <div class="tab-pane fade" id="v-pills-Medicine" role="tabpanel" aria-labelledby="v-pills-Medicine-tab">
                            <h5 class="tabBigHead">Lorem Ipsum Preventive Medicine</h5>
                            <p class="tabContentPara">The Apollo Institutes of Transplant program is one of the world’s largest and most comprehensive solid multi-organ transplantation in India</p>
                            <p class="tabContentPara">The Institutes are well known for several multi-organ transplant procedures such as liver transplant, kidney transplant, corneal transplant, heart transplant, intestinal and GI transplant, pancreatic transplant and pediatric transplant. Apollo Hospitals has been a leader in the field of organ transplants and has been considered as one of the best organ transplant hospitals in India. The first successful pediatric and adult liver transplants in India were performed at Apollo Hospitals in November 1998. With over 90% success rates for multiple transplants in India our organ transplant center is a beacon of quality and hope for patients from across the world.</p>
                            <p class="tabContentPara">The experience and expertise of our Consultants, integrated team approach, superior outcomes and the excellent infrastructure make Apollo Hospitals an ideal choice for transplants. Our Organ Transplant Surgeon and allied teams work with the organ donor and recipient before, during and after surgery to ensure the greatest likelihood of superior results.</p>
                            <p class="tabContentPara">Our Transplant Centres have all the necessary high-end equipment and state of the art infrastructure to perform living donor surgery and cadaver surgery. An eminent pool of internationally renowned Transplant Surgeons, Nephrologists, Gastroenterologists, Pediatric Gastroenterologists, Pediatric Surgeons, Anesthetists, Intensivists and Physicians deliver the highest standards of care. Over the past decade the Institutes have built up a reputation of excellence and expertise.</p>
